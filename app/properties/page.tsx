...
import { OrgContext } from '@/app/context/OrgContext'; // NEW IMPORT
...
export default function PropertiesPage() {
  ...
  const { orgId } = useContext(OrgContext); // NEW: Grabs the current company's ID!
  ...
  async function saveProperty() {
    // NEW: We attach the organization_id to the insert so it belongs to this specific SaaS customer!
