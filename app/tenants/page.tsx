...
export default function TenantProfilePage() {
  ...
  async function askLeaseQuestion(e: any) {
    ...
    try {
      const res = await fetch('/api/chat-lease', {
        method: 'POST', headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ leaseId: lease.id, question: leaseQuestion })
      });
              ...
              {lease && (
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <p className="text-xs text-gray-500 mb-3">Ask a question about this specific tenant's lease agreement.</p>
